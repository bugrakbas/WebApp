...
namespace WebApp.Controllers
{
    public class TvShowsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Genre,Rating,ImdbUrl,ImageUrl,WatchMovieUrl")] TvShow tvShow)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Genre,Rating,ImdbUrl,ImageUrl,WatchMovieUrl")] TvShow tvShow)
        {
            if (id != tvShow.Id)
            {
                return NotFound();
